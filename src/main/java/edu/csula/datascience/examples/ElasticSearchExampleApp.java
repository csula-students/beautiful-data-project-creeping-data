...
public class ElasticSearchExampleApp {
    private final static String indexName = "videodata";
    private final static String typeName = "videoss";

    public static void main(String[] args) throws URISyntaxException, IOException {
        Node node = nodeBuilder().settings(Settings.builder()
                .put("cluster.name", "ceasar-is-the-best")
        ...
        File csv = new File(
                ClassLoader.getSystemResource("text4.csv")
                        .toURI()
        );
        ...
        BulkProcessor bulkProcessor = BulkProcessor.builder(
                ...
                new BulkProcessor.Listener() {
                    ...
                    public void beforeBulk(long executionId,
                                           BulkRequest request) {
                        System.out.println("Before bulk insert");
                    }
        ...
        try {
            ...
            parser.forEach(record -> {
                ...
                if (
                        !record.get("title").isEmpty() &&
                                !record.get("viewCount").isEmpty()
                        ) {
                    Movie temp = new Movie(
                            record.get("title"),
                            record.get("publishedDate"),
                            Integer.valueOf(record.get("dislikeCount")),
                            Integer.valueOf(record.get("viewCount")),
                            Integer.valueOf(record.get("likeCount")),
                            Integer.valueOf(record.get("commentCount")),
                            record.get("word")
                    );
    ...
    static class Movie {
        ...
        public Movie(String title, String publishedDate, int dislikeCount, int viewCount,
                     int likeCount, int commentCount, String word) {
